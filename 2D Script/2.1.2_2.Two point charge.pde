...
{ const / variable }
   ...
   { U1 and U2 }
   				...
   				U2= Q2 * k / sqrt( ( x -  dist ) ^ 2 + y ^ 2 )			E2 = -grad( U2 )			Em2 = magnitude( E2 )	Ex2 = -dx( U2 )	Ey2 = -dy( U2 )		{ potencjal / gradient / magnitude / x-component / y-component for 	2 }		
   														...
   														E = -grad( U )     			Em = magnitude( E )          	{ portential / gradient / agnitude for U1 + U2 }
...
BOUNDARIES
   ...
   { position of points }
		START( + dist + r0 , d0 ) 		VALUE( U ) = U1		ARC ( CENTER = +dist , 0 ) 	ANGLE = 360		{ left charge }
    	START( -  dist -  r0 , d0 ) 		VALUE( U ) = U2		ARC ( CENTER = - dist , 0 ) 	ANGLE = 360		{ right charge }
